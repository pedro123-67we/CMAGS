  ...
  return (
    <KeyboardAwareScrollView>
      <View style={styles.container}>
        ...
        <TextInput style={styles.inputRed}  placeholder="Tipo de cancer" />
        ...
        <TextInput style={styles.inputRed}  placeholder="Fecha Primer EVAT rojo" />
        <TextInput style={styles.inputRed}  placeholder="Hora Primer EVAT rojo" />
        ...
        <TextInput style={styles.inputRed}  placeholder="Intervencion?(UCI o Pedi)" />
        <TextInput style={styles.inputRed}  placeholder="Hora de intervencion" />
        <TextInput style={styles.inputRed}  placeholder="Tipo de intervencion" />
        <TextInput style={styles.inputRed}  placeholder="Duracion de EVAT rojo(Horas)" />
        ...
        <TextInput style={styles.inputRed}  placeholder="Mortalidad de UCI o piso" />
